...
namespace DAL.Tests
{
    ...
    public class ExcelReaderTests
    {
        ...
        //    double madad = ExcelReader.GetDoubleValue(ExcelReader.ExcelData.Madad, new DateTime(2016, 8, 1));
        ...
        //    double madad = ExcelReader.GetDoubleValue(ExcelReader.ExcelData.Madad, new DateTime(2016, 9, 1));
        ...
        //    double madad = ExcelReader.GetDoubleValue(ExcelReader.ExcelData.Madad, new DateTime(2017, 9, 1));
        ...
        //    double ribit = ExcelReader.GetDoubleValue(ExcelReader.ExcelData.IncrementedRibit, new DateTime(1990, 2, 20));
        ...
        //    double ribit = ExcelReader.GetDoubleValue(ExcelReader.ExcelData.IncrementedRibit, new DateTime(2050, 1, 20));
